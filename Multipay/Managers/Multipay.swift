...
public class Multipay {
    ...
    public class func start(vcToPresent: UIViewController, integrationWalletAppToken: String, referenceNumber: String?, delegate: MultipayDelegate? = nil, language: Language? = nil, environment: Environment = .production, offlineMode: Bool = false, walletToken: String? = nil, integrationObfuscationKey: String, userPreset: UserPreset? = nil) {
        Multipay.offlineModeActive = offlineMode
        Multipay.delegate = delegate
        
        CoreManager.start(vcToPresent: vcToPresent, walletAppToken: integrationWalletAppToken, referenceNumber: referenceNumber, languageCode: language?.rawValue ?? NSLocale.preferredLanguages[0], environment: environment, walletToken: walletToken, obfuscationKey: integrationObfuscationKey, userPreset: userPreset)
    }
    
    //MARK: SDK FUNCTIONS
    
    public class func callUnSelectWallet(delegate: MultipayDelegate, integrationWalletAppToken: String, walletToken: String, language: Language? = nil, referenceNumber: String?, integrationObfuscationKey: String, offlineMode: Bool = false) {
        
        LoggerHelper.logger.debug("callUnSelectWallet is called")
        
        Auth.obfuscationKey = integrationObfuscationKey
        ...
        var parameters = [walletAppTokenKey : integrationWalletAppToken.count > 0 ? integrationWalletAppToken : Auth.walletAppToken]
    ...
    public class func getWallet(delegate: MultipayDelegate, integrationWalletAppToken: String, walletToken: String, language: Language? = nil, referenceNumber: String?, integrationObfuscationKey: String, offlineMode: Bool = false) {
    ...
    public class func callConfirmPayment(delegate: MultipayDelegate, integrationPaymentAppToken: String, language: Language? = nil, requestId: String, walletToken: String, merchantReferenceNumber: String, terminalReferenceNumber: String, transferReferenceNumber: String, transactionDetails: [TransactionDetailModel], sign: String, integrationObfuscationKey: String, offlineMode: Bool = false) {
        ...
        parameters[paymentAppTokenKey] = integrationPaymentAppToken as AnyObject
