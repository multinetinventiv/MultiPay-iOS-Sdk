...
struct ServiceConstants {
    ...
    // AppCenter
    static let AppCenterAPIKey          = "199fb84e-5017-4788-8867-bd2d3c35944c"
    ...
    static var kKeychainSessionId       = "sessionID"
    static var kKeychainOpyId           = "opyId"
    static var kNetmeraTestSdkKey       = ""
    static var kNetmeraProdSdkKey       = ""
    static var kNetmeraAppGroupName     = "group.com.multinet.carousel"
